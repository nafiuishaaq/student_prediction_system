            ...
            <div class="col-lg-8 col-12 m-auto">
                <div id="auth-left">
                    ...
                    <form action="code.php" method="post">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="password" name="r_pass" class="form-control form-control-xl" placeholder="Confirm Password" required>
                            <div class="form-control-icon">
                                <i class="bi bi-shield-lock"></i>
                            </div>
                        </div>
                        <button name="sign_up" class="btn btn-primary btn-block btn-lg shadow-lg mt-5">Sign Up</button>
                    </form>
