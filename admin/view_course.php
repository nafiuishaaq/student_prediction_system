                ...
                <div class="col-md-12 col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title text-center">VIEW COURSES</h4>
                        </div>
                                                ...
                                                <div class="form-group has-icon-left">
                                                    <div class="position-relative">
                                                        <input type="text" class="form-control"
                                                            placeholder="Search Course..." name="Subject">
                                    ...
                                    <table class="table table-lg">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-bold-500">Lorem ipsum dolor sit amet consectetur
                                                    adipisicing elit.</td>
                                                <form action="" method="post">
                                                    <td><button name="edit_course" class="btn btn-success btn-sm"> <i
                                                ...
                                                <form action="code.php" method="post">
                                                    <td class="text-bold-500">
                                                        ...
                                                        <button name="del_course" class="btn btn-danger btn-sm"> <i
